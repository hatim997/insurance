        ...
        <table class="table table-striped">
         <thead class="table-light">
          ...
          <tbody> 
             ...
             <?php $__currentLoopData = $user->agencies; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $ag): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
             <?php echo e($ag->agency_address); ?>         
            <tr>
              <td>
              ...
              <td class=""><i class="mdi mdi-account-outline mdi-24px text-primary me-1"></i><?php echo e($user->role_id); ?></td>              
              <td>              <span class="badge bg-label-success rounded-pill">Active</span>            </td>
            <td>
              <div class="dropdown">
                <button type="button" class="btn p-0 dropdown-toggle hide-arrow" data-bs-toggle="dropdown"><i class="mdi mdi-dots-vertical"></i></button>
                <div class="dropdown-menu">                
                  <a class="dropdown-item" onclick="openEditModal(<?php echo e($user); ?>)"><i class="mdi mdi-pencil-outline me-1"></i> Edit</a>
            ...
            <?php elseif($user->role_id=='truker'): ?>
            <?php $__currentLoopData = $user->truckers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            ...
            <?php $__currentLoopData = $user->shippers; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo e($fr->shipper_address); ?>
            ...
            <?php elseif($user->role_id=='freight'): ?>
            
            <?php $__currentLoopData = $user->freights; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $fr): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
            <?php echo e($fr->freight_address); ?>
...
<td>              <span class="badge bg-label-success rounded-pill">Active</span>            </td>
            ...
            <tr>
              ...
              <td class=""><?php echo e($user->email); ?></td>    
              <td class=""><i class="mdi mdi-chart-donut mdi-24px text-success me-1"></i><?php echo e($user->role_id); ?></td>
...
<?php echo $__env->make('layouts/contentNavbarLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\laravel\resources\views/users.blade.php ENDPATH**/ ?>