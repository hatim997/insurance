            ...
            <li class="nav-item "><a href="#" class="nav-link-item ">Services</a></li>                           
             <li class="nav-item "><a href="#" class="nav-link-item">Contact</a></li>
                    ...
                    <div class="flex items-center gap-6">
                        <a class='btn-text hidden hover:text-ColorPurple sm:inline-block' href='<?php echo e(route('auth-login-basic')); ?>'>Login</a>
                        <a class='btn is-black btn-animation group hidden rounded sm:inline-block' href='<?php echo e(route('auth-login-basic')); ?>'><span>Sign up free</span></a>
                        ...
                        <div class="container-default">
                            ...
                            <div class="grid gap-x-4 lg:gap-x-16 gap-y-10 sm:grid-cols-2 md:grid-cols-4 lg:grid-cols-[1fr_repeat(3,_auto)] xl:lg:grid-cols-[1fr_repeat(4,_auto)]  xl:gap-x-20">
                                ...
                                <div class="flex flex-col gap-y-6 md:col-span-1 lg:col-span-1">
                                    ...
                                    <ul class="flex flex-col gap-y-[10px] capitalize">
                                        <li>
                                            <a class='hover:opcity-100 underline-offset-4 opacity-80 transition-all duration-300 ease-linear hover:underline' href='<?php echo e(route('auth-login-basic')); ?>'>Signup</a>
                                        </li>
                                        <li>
                                            <a class='hover:opcity-100 underline-offset-4 opacity-80 transition-all duration-300 ease-linear hover:underline' href='<?php echo e(route('auth-login-basic')); ?>'>Login</a>
                                        </li>
                                        <li>
