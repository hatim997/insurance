...
<head>
        ...
        <script src="{{asset('assets/plugins/iesupport/respond.js')}}"></script>
        <![endif]-->
    </head>
    <body id="home">
        <!-- Preloader -->
        ...
        <main class="wrapper">
                    ...
                    <div class="theme-container container">
                        <div class="row">
                            <div class="col-md-2 col-sm-2">
                                ...
                                <a class="navbar-logo" href="#"> <img src="{{asset('assets/img/logo.png')}}" alt="logo" /> </a>
                            </div>
            ...
            <article> 
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <div class="about-us">
                                    ...
                                    <ul class="feature">
                                        <li> 
                                            <img alt="" src="{{asset('assets/img/icons/icon-2.png')}}" class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s" /> 
                                        ...
                                        <li> 
                                            <img alt="" src="{{asset('assets/img/icons/icon-3.png')}}" class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s" /> 
                                            <div class="feature-content wow rotateInDownRight" data-wow-offset="50" data-wow-delay=".30s"> 
                                        ...
                                        <li> 
                                            <img alt="" src="{{asset('assets/img/icons/icon-4.png')}}" class="wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s" /> 
                                            <div class="feature-content wow rotateInDownRight" data-wow-offset="50" data-wow-delay=".30s"> 
                ...
                <section class="steps-wrap mask-overlay pad-80">                
                    ...
                    <div class="step-img wow slideInRight" data-wow-offset="50" data-wow-delay=".20s"> <img src="{{asset('assets/img/block/step-img.png')}}" alt="" /> </div>
                </section>
                <!-- /.Steps -->
                        ...
                        <div class="row">
                            <div class="col-md-11 col-md-offset-1">
                                ...
                                <div class="delivery-img pt-10">
                                    <img alt="" src="{{asset('assets/img/block/delivery.png')}}" class="wow slideInLeft" data-wow-offset="50" data-wow-delay=".20s"/>
                                </div>
                            </div>
                        </div>
                    </div>
                        ...
                        <div class="testimonial-slider no-pagination pad-120">
                            <div class="item">
                                <div class="testimonial-img darkclr-border theme-clr font-2 wow fadeInUp" data-wow-offset="50" data-wow-delay=".20s">
                                    <img alt="" src="{{asset('assets/img/block/testimonial-1.png')}}" />
                                    <span>,,</span>
                                </div>
